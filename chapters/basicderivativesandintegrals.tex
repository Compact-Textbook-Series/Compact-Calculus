...
\index{derivatives!of a constant}\paragraph{Derivative of a constant:} A constant doesn't depend on any value, therefore the derivative of a constant $c$ is zero:
\begin{equation}
    \dv{x}(c) = 0.
\end{equation}
